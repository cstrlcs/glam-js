// Do not edit this file directly. Edit the template instead: `./codegen/templates/vec.txt`.
...
export class Vec3 {
	...
	/** All `NaN`. (NaN, NaN..) */
	static get NAN() {
		return Vec3.splat(Number.NaN);
	}

	/** All `Number.POSITIVE_INFINITY`. (Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY..) */
	static get INFINITY() {
		return Vec3.splat(Number.POSITIVE_INFINITY);
	}

	/** All `Number.NEGATIVE_INFINITY`. (Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY..) */
	static get NEG_INFINITY() {
		return Vec3.splat(Number.NEGATIVE_INFINITY);
	}

	/** A unit vector pointing along the positive X axis. (1, 0, 0) */
	static get X() {
		return new Vec3(1, 0, 0);
	}

	/** A unit vector pointing along the positive Y axis. (0, 1, 0) */
	static get Y() {
		return new Vec3(0, 1, 0);
	}

	/** A unit vector pointing along the positive Z axis. (0, 0, 1) */
	static get Z() {
		return new Vec3(0, 0, 1);
	}

	/** A unit vector pointing along the negative X axis. (-1, 0, 0) */
	static get NEG_X() {
		return new Vec3(-1, 0, 0);
	}

	/** A unit vector pointing along the negative Y axis. (0, -1, 0) */
	static get NEG_Y() {
		return new Vec3(0, -1, 0);
	}

	/** A unit vector pointing along the negative Z axis. (0, 0, -1) */
	static get NEG_Z() {
		return new Vec3(0, 0, -1);
	}

	/** The unit axes. [Vec3.X, Vec3.Y, Vec3.Z] */
	static get AXES() {
		return [Vec3.X, Vec3.Y, Vec3.Z];
	}

	/** Creates a vector with all elements set to v. (v, v, v) */
	...
	isNegativeBitmask(): number {
		return (
			Number(this.x < 0) | (Number(this.y < 0) << 1) | (Number(this.z < 0) << 2)
		);
	}
